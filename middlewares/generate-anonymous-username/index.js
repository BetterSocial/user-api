...
const GenerateAnonymousUsernameMiddleware = (req, res, next) => {
  ...
  if (contentType === 'post')
    return BodyValidationMiddleware.generatePostAnonymousUsername(req, res, next);
  else if (contentType === 'comment')
    return BodyValidationMiddleware.generateCommentAnonymousUsername(req, res, next);
