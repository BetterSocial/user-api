        ...
        esb
          ...
          .query(
            esb
              ...
              .should([esb.matchQuery('description', query), esb.matchQuery('title', query)])
          )
          // .function(
          ...
          .functions([
            esb
              .decayScoreFunction('gauss', 'content_created_at')
              .origin(createdAt)
              .decay(0.8)
              .scale('3d')
              .weight(5),
            esb
              .weightScoreFunction()
              .filter(
                esb.boolQuery().mustNot(esb.matchQuery('domain_page_id', domain_page_id))
                // .boost(3)
              )
              .weight(2)
          ])
