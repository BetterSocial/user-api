...
const {UserFollowUser, UserFollowUserHistory, FcmToken} = require('../../databases/models');
...
module.exports = async (req, res) => {
  try {
    ...
    const {user_id_follower, user_id_followed, follow_source} = req.body;
    ...
    if (userFollow === null) {
      try {
        const result = await sequelize.transaction(async (t) => {
          const returnUserFollowUser = await UserFollowUser.create(
            {
